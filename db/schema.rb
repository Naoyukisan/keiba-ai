...
ActiveRecord::Schema[8.0].define(version: 2025_10_31_194500) do
  ...
  create_table "prediction_histories", force: :cascade do |t|
    t.string "race_name"
    t.date "race_date"
    t.text "result"
    t.datetime "created_at", null: false
  ...
  create_table "prediction_methods", force: :cascade do |t|
    ...
    t.index ["active"], name: "index_prediction_methods_on_active"
  end
  ...
  add_foreign_key "blogs", "users", on_delete: :nullify
